...
An essential component of Estimating Discharge using Mass-conserved Manning's equation (ED McMan) is Bathymetry estimation. The purpose of this document is to outline and demonstrate inference of Bathymetry from Mass-conserved Manning's equation (Bat McMan). 
...
Note that this equation is linear in both $A_{0,i}$ and $\delta A_{it}$. 
