...
Because of the funny sum-in-log term, this is difficult if not impossible to sample from directly. Instead we must resort to Metropolis-Hastings. The question is what proposal distribution to use. I propose (hah) the distribution given by the following likelihood $\ell'()$
